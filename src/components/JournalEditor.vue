...
const canSave = computed(
    () => content.value.trim().length > 0 && rating.value > 0,
);
...
<template>
    <div class="space-y-6">
        ...
        <textarea
            ...
            class="w-full resize-none border border-line bg-surface p-4 text-base leading-relaxed text-ink transition-colors placeholder:text-ink-soft focus:border-accent focus:outline-none"
        />
        ...
        <div class="flex items-center gap-4">
            <button
                ...
                @click="save"
                class="bg-accent px-5 py-2.5 text-sm font-medium text-white transition-opacity hover:enabled:opacity-90 disabled:opacity-30 cursor-pointer"
            >
